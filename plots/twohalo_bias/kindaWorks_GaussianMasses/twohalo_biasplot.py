...
simno = 0
while os.path.isfile("./ZA_pk_" + str(startind + simno) + ".dat"):
	simno+=1

rows = file_len("./ZA_pk_" + str(startind)+ ".dat")
...
pl.plot(data_model_debiased[:,0], data_model_debiased[:,1], label="model monopole debiased")
