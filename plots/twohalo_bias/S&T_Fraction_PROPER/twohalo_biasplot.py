...
pl.errorbar(ks, mean_mono_debiased, yerr=err_on_mean_mono_debiased, label="Pk all haloes debiased")
pl.errorbar(ks, mean_mono_debiased_mmin, yerr=err_on_mean_mono_debiased_mmin, label="Pk Mmin haloes debiased")
pl.errorbar(ks, mean_mono_debiased_mmax, yerr=err_on_mean_mono_debiased_mmax, label="Pk Mmax haloes debiased")
...
pl.plot(data_model_bveff[:,0], data_model_bveff[:,1], label="model debiased b_eff")
pl.plot(data_model_bvmin[:,0], data_model_bvmin[:,1], label="model debiased b_Mmin")
pl.plot(data_model_bvmax[:,0], data_model_bvmax[:,1], label="model debiased b_Mmax")
