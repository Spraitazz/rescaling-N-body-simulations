...
for i in xrange(0, simno):
	this_data = np.loadtxt("./GR_combined_" + str(i+1) + ".dat")
	this_data_rs = np.loadtxt("./GR_combined_redshift_" + str(i+1) + ".dat")
	#print data[:,1]
	monos += this_data[:,1]
...
realspace_monos_out = open("./GR_realspace_mono_avg.dat", "w")
redshift_monos_out = open("./GR_redshift_mono_avg.dat", "w")
redshift_quadros_out = open("./GR_redshift_quadro_avg.dat", "w")
