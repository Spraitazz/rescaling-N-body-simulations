...
axarr[0].plot(data_model[:,0], data_model[:,1], label=r"model $P_{0}(k)$")
axarr[0].errorbar(ks, mean_mono, yerr=err_on_mean_mono, label=r"measured $P_{0}(k)$")

axarr[0].plot(data_model[:,0], data_model[:,2], label=r"model $P_{2}(k)$")
axarr[0].errorbar(ks, mean_quadro, yerr=err_on_mean_quadro, label=r"measured $P_{2}(k)$")


axarr[0].legend(loc="best")
axarr[0].set_ylim(1.5e1,2.3e3)
...
pl.savefig("./ZA.pdf", bbox_inches='tight')
